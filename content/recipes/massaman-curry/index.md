...
ingredients:
  ...
  - "1 | Cumin seed (tsp)"
  - "1 | Coriander seed (tsp)"
  - "0.25 | Ground cinnamon (tsp)"
  - "Dash of nutmeg"
  - "2 | Maple syrup (tbsp)"
  - "1 | Soy sauce (tbsp)"
  - "2 | Peanut butter or almond butter (tbsp)"
  - "700 | Full-fat coconut milk (ml)"
  - "1 | Lime juice (tbsp)"
  - "1 | Tamarind paste (tbsp)"
  - "500 | Baby potatoes (grams)"
  - "2 | Large carrots, chopped"
  - "2 | Shallots, thinly sliced"
  - "50 | Peanuts (grams)"
  - "Peanuts and fresh coriander (for garnish)"
  - "Pandan or jasmine rice (to serve)"
  - "Green beans (to serve)"
  - "Crispy tofu or vegan protein bites (to serve)"
notes:
  - "If you want to save time on the spices, you can simply use a pre-made Massaman paste instead of the red curry paste + spices."
---

Heat 1/2 cup (about 120ml) of the coconut milk in a large pot or wok over medium heat until it begins to bubble and the oil starts to slightly separate. Add the red curry paste, cumin seeds, coriander seeds, cinnamon, and nutmeg. Stir well and fry for 1-2 minutes until deeply fragrant.
